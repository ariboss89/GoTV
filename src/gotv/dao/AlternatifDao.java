...
import gotv.model.tb_alternatif;
...
public class AlternatifDao extends tb_alternatif{
    ...
    public void Save(String nama, String alamat) {
        con = new Koneksi();
        con.connect();
        try {
            st = con.conn.createStatement();
            query = "insert into tb_alternatif(nama, alamat)values('" + nama + "','" + alamat + "')";
    ...
    public void Update(int Id, String nama, String alamat) {
        ...
        try {
            st = con.conn.createStatement();
            query = "update tb_alternatif set nama ='" + nama + "', alamat ='"+alamat+"' where Id = '" + Id + "'";
            st.executeUpdate(query);
            st.close();
            con.conn.close();
