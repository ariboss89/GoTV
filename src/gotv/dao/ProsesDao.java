...
public class ProsesDao extends tb_perankingan{
    ...
    public void Save(String Id, String nama, Double c1, Double c2,Double c3,Double c4) {
        con = new Koneksi();
        con.connect();
        try {
            st = con.conn.createStatement();
            query = "insert into tb_perankingan(Id, alternatif, c1, c2, c3, c4)values('"+Id+"','" + nama + "','" + c1 + "', '"+c2+"', '"+c3+"', '"+c4+"')";
    ...
    public void Update(String Id, String nama, Double c1, Double c2,Double c3,Double c4) {
        con = new Koneksi();
        con.connect();
        try {
            st = con.conn.createStatement();
            query = "update tb_perankingan set alternatif ='" + nama + "', c1 ='"+c1+"', c2 ='"+c2+"', c3 ='"+c3+"', c4 ='"+c4+"' where Id = '" + Id + "'";
            st.executeUpdate(query);
            st.close();
            con.conn.close();
